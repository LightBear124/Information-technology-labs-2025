...
1. Скачать gitlab-runner: используем инструкцию, предоставляемую Gitlab:
Скачиваем библиотеку в папку bin:
...
В результате получаем выполненные jobы:
