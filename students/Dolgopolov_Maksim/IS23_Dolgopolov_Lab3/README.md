...
[Фото 1 задание 2](./assets/containercommands1.PNG)

[Фото 2 задание 2](./assets/containercommands2.PNG)
...
[Фото 1 задание 3](./assets/3task1.PNG)

Комбинация Ctrl+C отправляет сигнал потоку attach об прекращении отслеживания.

[Фото 2 задание 3](./assets/3task2.PNG)

[Фото 3 задание 3](./assets/3task3.PNG)

[Фото 4 задание 3](./assets/3task4.PNG)

[Фото 5 задание 3](./assets/3task5.PNG)

Поскольку мы изменили прослушиваемые порты (listen) с 80 на 81, по итогу nginx в контейнере прослушивает только 81 порт.

[Фото 6 задание 3](./assets/3task6.PNG)

Удалить запущенный контейнер одной командой можно при помощи команды docker rm -f custom-nginx-t2 (параметр -f - force).

### Задание 4.

[Фото 1 задание 4](./assets/4task1.PNG)

[Фото 2 задание 4](./assets/4task2.PNG)

### Задание 5.

Были созданы compose.yaml

[Compose.yaml задание 5](./assets/5taskcomposeyamlbefore.PNG)

И docker-compose.yaml

[docker-compose.yaml задание 5](./assets/5taskdockercompose.PNG)

Запуск docker compose up -d:

[Фото 1 задание 5](./assets/5task1.PNG)
...
[Compose.yaml задание 5](./assets/5taskcomposeyamlafter.PNG)

[Два compose задание 5](./assets/5taskmiltimpecompose.PNG)

Далее пушим изменения:

[Фото 3 задание 5](./assets/5task3.PNG)
...
[Фото 4 задание 5](./assets/5task4.PNG)

При удалении compose.yaml видим:

[Фото 5 задание 5](./assets/5task5.PNG)
